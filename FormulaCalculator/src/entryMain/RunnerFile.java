	...
	public RunnerFile() {
		...
		btnNewButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				// First row values
				long FirstRowLow = integerPart - 1;
				long FirstRowCurrent = integerPart;
				long FirstRowHigh = integerPart + 1;

				// Last row values
				long LastRowLow = integerPart;
				long LastRowCurrent = integerPart + 1;
				long LastRowHigh = integerPart + 2;

				// 0 degree row values
				long ZeroDegreeLow = (long) Math.pow(FirstRowLow, 2);
				System.out.println("ZeroDegreeLow: " + ZeroDegreeLow);
				long ZeroDegreeCurrent = (long) Math.pow(FirstRowCurrent, 2);
				System.out.println("ZeroDegreeCurrent: " + ZeroDegreeCurrent);
				long ZeroDegreeHigh = (long) Math.pow(FirstRowHigh, 2);
				System.out.println("ZeroDegreeHigh: " + ZeroDegreeHigh);

				// 360 degree row values
				long ThreeSixtyDegreeLow = (long) Math.pow(LastRowLow, 2);
				long ThreeSixtyDegreeCurrent = (long) Math.pow(LastRowCurrent, 2);
				long ThreeSixtyDegreeHigh = (long) Math.pow(LastRowHigh, 2);

				// Constant difference per column
				int DifferenceLow = (int) (ThreeSixtyDegreeLow - ZeroDegreeLow);
				System.out.println("DifferenceLow: " + DifferenceLow);
				int DifferenceCurrent = (int) (ThreeSixtyDegreeCurrent - ZeroDegreeCurrent);
				System.out.println("DifferenceCurrent: " + DifferenceCurrent);
				int DifferenceHigh = (int) (ThreeSixtyDegreeHigh - ZeroDegreeHigh);
